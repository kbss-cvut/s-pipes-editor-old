...
var JsonLdUtils = function () {
    ...
    (0, _createClass3.default)(JsonLdUtils, null, [{
        ...
        value: function processTypeaheadOptions(options) {
            if (!options) {
                return [];
            }
            return options.map(function (item) {
                return JsonLdUtils.jsonLdToTypeaheadOption(item);
            });
        }
        ...
        value: function jsonLdToTypeaheadOption(jsonLd) {
            if (!jsonLd) {
                return null;
            }
            var res = {
                id: jsonLd['@id'],
                type: jsonLd['@type'],
                name: JsonLdUtils.getJsonAttValue(jsonLd, RDFS_LABEL)
            };
            if (jsonLd[RDFS_COMMENT]) {
                res.description = JsonLdUtils.getJsonAttValue(jsonLd, RDFS_COMMENT);
            }
            return res;
        }
        ...
        value: function processSelectOptions(jsonLd) {
            return jsonLd.map(function (item) {
                return {
                    value: item['@id'],
                    label: JsonLdUtils.getJsonAttValue(item, RDFS_LABEL),
                    title: JsonLdUtils.getJsonAttValue(item, RDFS_COMMENT)
                };
            });
        }
    }, {
...
},{"babel-runtime/helpers/classCallCheck":4,"babel-runtime/helpers/createClass":5,"babel-runtime/helpers/typeof":6}]},{},[74]);

...
var DateTimeField = function (_Component) {
    ...
    function DateTimeField() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(DateTimeField)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.resolvePropsInputFormat = function () {
            ...
            if (_this.state.showPicker) {
                ...
                gBCR = _reactDom2.default.findDOMNode(_this.dtpButton).getBoundingClientRect();
                classes = {
                ...
                widgetNode = _reactDom2.default.findDOMNode(_this.widget);
                pickerNode = _reactDom2.default.findDOMNode(_this.datetimepicker);
                offset.top = offset.top + pickerNode.offsetHeight;
                scrollTop = window.pageYOffset !== undefined ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop;
                placePosition = _this.props.direction === "up" ? "top" : _this.props.direction === "bottom" ? "bottom" : _this.props.direction === "auto" ? offset.top + widgetNode.offsetHeight > window.offsetHeight + scrollTop && widgetNode.offsetHeight + pickerNode.offsetHeight > offset.top ? "top" : "bottom" : void 0;
                if (placePosition === "top") {
                    offset.top = -widgetNode.offsetHeight - _this.clientHeight - 2;
                    classes.top = true;
    ...
    (0, _createClass3.default)(DateTimeField, [{
        ...
        value: function render() {
            ...
            var sizeProps = {};
            if (this.props.size) {
                sizeProps.bsSize = this.props.size;
            }
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    (0, _extends3.default)({ validationState: this.props.validation, ref: function ref(c) {
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        _react2.default.createElement(_reactBootstrap.FormControl, (0, _extends3.default)({ onChange: this.onChange, type: "text",
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                (0, _extends3.default)({ onBlur: this.onBlur, onClick: this.onClick,
                                    ref: function ref(c) {
                                        return _this2.dtpButton = c;
                                    } }, sizeProps),
...
DateTimeField.propTypes = {
    ...
    size: _react.PropTypes.oneOf([_Constants2.default.SIZE_SMALL, _Constants2.default.SIZE_LARGE]),
    daysOfWeekDisabled: _react.PropTypes.arrayOf(_react.PropTypes.number),
    validation: _react.PropTypes.oneOf(['success', 'warning', 'error'])
};

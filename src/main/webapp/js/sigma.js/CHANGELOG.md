...
- Added the `attachBefore` method to `sigma.classes.view` (thanks to [@sheymann](https://github.com/sheymann))
- Fixed buggy behaviour with the dragNodes plugin when container is offset (thanks to [@Pie21](https://github.com/Pie21))
- Updated NPM dev dependencies
- Fixed a leak in `sigma.classes.view` (details at [#340](https://github.com/jacomyal/sigma.js/issues/340))

...
class ViewController {
  ...
  def getAllViews: ResponseEntity[Any] =
    viewService.getAllViews match {
      ...
      case _ => new ResponseEntity(HttpStatus.NOT_FOUND)
    }
  ...
  def getView(@PathVariable id: String): ResponseEntity[Any] =
    viewService.getView(id) match {
      ...
      case Success(None) => new ResponseEntity(HttpStatus.NOT_FOUND)
  ...
  def createFromSpipes(@PathVariable script: String): ResponseEntity[Any] = {

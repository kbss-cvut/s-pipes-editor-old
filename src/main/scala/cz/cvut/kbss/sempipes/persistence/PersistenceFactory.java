...
import static cz.cvut.kbss.sempipes.util.ConfigParam.DRIVER;
import static cz.cvut.kbss.sempipes.util.ConfigParam.REPOSITORY_URL;
...
public class PersistenceFactory {
    ...
    private static Map<String, String> initParams() {
        ...
        map.put(SCAN_PACKAGE, "cz.cvut.kbss.sempipes.model");

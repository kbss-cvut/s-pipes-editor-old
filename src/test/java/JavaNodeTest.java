...
import cz.cvut.kbss.sempipes.config.AppConfig;
import cz.cvut.kbss.sempipes.config.RestConfig;
import cz.cvut.kbss.sempipes.config.RestConfig2;
...
//    private GraphDao graphDao;
    ...
    public void getTest2() throws Exception {
        MvcResult result = mockMvc.perform(get("/javaTest2")).andExpect(status().isOk()).andReturn();
        String jsonLd = result.getResponse().getContentAsString();
